...
// 上传公共服务
smartUI.factory('uploadService', ['$http', function($http) {
...
.directive('uploadFile',['uploadService', function(uploadService){
    return {
       restrict: 'EA',
       replace: true,
                        ...
                        if (file) {
                          ...
                          if (html) {
                            ...
                            $(".upload_delete").click(function() {
                              uploadService.funDeleteFile(files[parseInt($(this).attr("data-index"))]);
                              return false; 
                            });
                            //提交按钮显示
                            $("#fileSubmit").show();  
